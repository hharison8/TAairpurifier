...
void loop() {
  ...
  if (Firebase.Firestore.getDocument(&fbdo, FIREBASE_PROJECT_ID, "", Path.c_str(), "")) {
    ...
    JsonObject documents_1 = doc["documents"][1];
    const char* documents_1_name = documents_1["name"];
    
    for (JsonPair documents_1_field : documents_1["fields"].as<JsonObject>()) {
      bool documents_1_fields_powerState_booleanValue = documents_1["fields"]["powerState"]["booleanValue"];
      bool documents_1_fields_autoMode_booleanValue = documents_1["fields"]["autoMode"]["booleanValue"];
      int documents_1_fields_sliderValue_integerValue = documents_1["fields"]["sliderValue"]["integerValue"];

      //stat CO  
      JsonObject documents_2 = doc["documents"][2];
      const char* documents_2_name = documents_2["name"];
      
      for (JsonPair documents_2_field : documents_2["fields"].as<JsonObject>()) {
        unsigned char CO0 = documents_2["fields"]["CO_0"]["stringValue"];
        unsigned char CO1 = documents_2["fields"]["CO_1"]["stringValue"];
        unsigned char CO2 = documents_2["fields"]["CO_2"]["stringValue"];
        unsigned char CO3 = documents_2["fields"]["CO_3"]["stringValue"];
        unsigned char CO4 = documents_2["fields"]["CO_4"]["stringValue"];
        unsigned char CO5 = documents_2["fields"]["CO_5"]["stringValue"];
        unsigned char CO6 = documents_2["fields"]["CO_6"]["stringValue"];
        unsigned char CO7 = documents_2["fields"]["CO_7"]["stringValue"];
        unsigned char CO8 = documents_2["fields"]["CO_8"]["stringValue"];
        unsigned char CO9 = documents_2["fields"]["CO_9"]["stringValue"];
        unsigned char CO10 = documents_2["fields"]["CO_10"]["stringValue"];
        unsigned char CO11 = documents_2["fields"]["CO_11"]["stringValue"];

        //stat PM2.5  
        JsonObject documents_4 = doc["documents"][4];
        const char* documents_4_name = documents_4["name"];

        for (JsonPair documents_4_field : documents_4["fields"].as<JsonObject>()) {
          unsigned char PM250 = documents_4["fields"]["PM25_0"]["stringValue"];
          unsigned char PM251 = documents_4["fields"]["PM25_1"]["stringValue"];
          unsigned char PM252 = documents_4["fields"]["PM25_2"]["stringValue"];
          unsigned char PM253 = documents_4["fields"]["PM25_3"]["stringValue"];
          unsigned char PM254 = documents_4["fields"]["PM25_4"]["stringValue"];
          unsigned char PM255 = documents_4["fields"]["PM25_5"]["stringValue"];
          unsigned char PM256 = documents_4["fields"]["PM25_6"]["stringValue"];
          unsigned char PM257 = documents_4["fields"]["PM25_7"]["stringValue"];
          unsigned char PM258 = documents_4["fields"]["PM25_8"]["stringValue"];
          unsigned char PM259 = documents_4["fields"]["PM25_9"]["stringValue"];
          unsigned char PM2510 = documents_4["fields"]["PM25_10"]["stringValue"];
          unsigned char PM2511 = documents_4["fields"]["PM25_11"]["stringValue"];

          if (documents_1_fields_powerState_booleanValue == true ){
            ...
            if (millis() - lasttime > 10000){
              ...
              if (!isnan(temperature) && !isnan(humidity) && !isnan(PM25) && !isnan(PM252)) {
                ...
                if (isnan(ppm)){
                  content.set("fields/CO/stringValue", String(ppm,1));
                  content.set("fields/CO_0/stringValue", String(ppm,1));
                }
                else{
                  content.set("fields/CO/stringValue", String(ppm2,1));
            ...
            if (documents_1_fields_autoMode_booleanValue ==  true){
            //Fussyfikasi CO
            //SSCO
            if (ppm <= 5){SSCO = 1;}
            ...
            tft.setTextSize(1);
            tft.drawCentreString("PM2.5",64, 30, 4); 
            tft.drawRect(24,20,80,90,TFT_YELLOW);
            tft.drawLine(24,60,103,60,TFT_YELLOW);

            tft.setTextSize(1);
            tft.drawCentreString("CO",174, 30, 4); 
            tft.drawRect(134,20,80,90,TFT_YELLOW);
            tft.drawLine(134,60,213,60,TFT_YELLOW);

            tft.setTextSize(1);
            tft.drawCentreString("Suhu",174, 140, 4); 
            tft.drawRect(134,130,80,90,TFT_YELLOW);
            tft.drawLine(134,170,213,170,TFT_YELLOW);
                
            tft.setTextSize(2);
            tft.drawCentreString("Lembab",64, 140, 1); 
            tft.drawRect(24,130,80,90,TFT_YELLOW);
            tft.drawLine(24,170,103,170,TFT_YELLOW);
                
            tft.setTextColor(TFT_BLACK);
            tft.setTextSize(2);
            tft.fillRoundRect(24,232,189,40,10,TFT_GREEN);
            tft.drawCentreString("ON/OFF", 124,245,1);
                
            tft.setTextColor(TFT_BLACK);
            tft.fillRoundRect(24,280,79,40,10,TFT_GREEN);
            tft.drawCentreString("Mode", 64,280,2);
                  
            tft.setTextColor(TFT_BLACK);
            tft.fillRoundRect(134,280,79,40,10,TFT_GREEN);
            tft.drawCentreString("Fan", 174,280,2);
            ...
            if (isnan(ppm)){
              ...
              tft.print(String(ppm,1));
            }
            else {
              tft.setTextSize(3);   
              tft.setCursor(142,75);
              tft.print(String(ppm2,1));
            }
            ...
            {
            touch_x = map (touch_x, 0, 240, 240, 0);
            touch_y = map (touch_y, 0, 320, 320, 0);
            ...
            //Check if touch is within button1 boundaries
            if (touch_x > BUTTON1_X && touch_x < BUTTON1_X + BUTTON1_W && touch_y > BUTTON1_Y && touch_y < BUTTON1_Y + BUTTON1_H) {
              ...
              tft.fillRoundRect(24,280,79,40,10, button_pressed_color);
              tft.setTextColor(TFT_WHITE, button_pressed_color);
              tft.setTextDatum(MC_DATUM);
              analogWrite(FAN_OUTPUT_PIN, 0);
              // Add action for Button 1
            }
          
            // Check if touch is within button2 boundaries
            ...
            // Check if touch is within button3 boundaries
            ...
            else if (documents_1_fields_autoMode_booleanValue == false){

              HAauto = documents_1_fields_sliderValue_integerValue;
